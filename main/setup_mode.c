...
static const char k_index_html[] =
    ...
    "<style>"
    "body{font-family:Arial,sans-serif;margin:20px;}pre{background:#f2f2f2;padding:10px;}"
    ".row{margin-bottom:12px;}#msg{margin:12px 0;color:#0b5;}#err{color:#c00;}"
    "</style>"
    "</head><body>"
    ...
    "if(!filled){"
    "document.getElementById('device_name').value=j.dev_name||'';"
